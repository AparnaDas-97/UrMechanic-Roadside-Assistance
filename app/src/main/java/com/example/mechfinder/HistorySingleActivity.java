            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && dataSnapshot.getChildrenCount() >0){
                    ...
                    if(driverMap.get("service").equals("Battery")){
                        ridePrice = Double.valueOf(distance) * 0.001 + 50;
                    }
                    if(driverMap.get("service").equals("Tyre")){
                        ridePrice = Double.valueOf(distance) * 0.001 + 20;
                    }
                    if(driverMap.get("service").equals("Towing")){
                        ridePrice = Double.valueOf(distance) * 0.001 + 100;
                    }
                }
