...
public class CustomersMapActivityOrigin extends FragmentActivity implements OnMapReadyCallback,
...

{
    ...
    private Button CustomerSettingButton,CustomerHistoryButton,CancelRequest;
    private String customerID;
    private LatLng CustomerPickUpLocation;
    private int radius = 1;
    private Boolean driverFound = false;
    private String driverFoundID,userID;
    ...
    Marker DriverMarker;
    private String requestService,serviceDesrc;
...
CancelRequest.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        endRide();
        Intent intent = new Intent(CustomersMapActivityOrigin.this,Pop.class);
            ...
            public void onClick(View v) {
                ...
                if(requestBol)
                {
                   ...
                   // DatabaseReference refService = FirebaseDatabase.getInstance().getReference().child("Customers Requests").child(userId).child("Service");
                    ...
                    ref.child(userId).child("service description").setValue(serviceDesrc);
...
*/
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CustomersMapActivityOrigin.this,MainActivity.class);
                startActivity(intent);
                //return;
        ...
        NearbyPlace.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CustomersMapActivityOrigin.this,MapsActivity.class);
                startActivity(intent);
            }
        });
/*
 ...
 */
        ...
        Dialog customDialog = new Dialog(CustomersMapActivityOrigin.this);
        ...
        dialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (TextUtils.isEmpty(serviceDesc.getText().toString())){
                    Toast.makeText(CustomersMapActivityOrigin.this, "Describe your problem ", Toast.LENGTH_SHORT).show();
                    return;
                }
                /*
                int selectId = serviceRadioGroup.getCheckedRadioButtonId();
                ...
                serviceDescRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        Toast.makeText(CustomersMapActivityOrigin.this,"Failed to read value",Toast.LENGTH_SHORT).show();
                    }
...
*/
    ...
    {
        Intent welcomeIntent = new Intent(CustomersMapActivityOrigin.this,WelcomeActivity.class);
