 ...
 */
       ...
       // Dialog customDialog = new Dialog(CustomersMapActivity.this);
        ...
        {
            serviceCharge2.setText("RS 150");
            estimatedCost = "150";

        }
        if(requestService.equals("Tyre"))
        {
            serviceCharge2.setText("RS 120");
            estimatedCost = "120";
        }
        if(requestService.equals("Others"))
        {
            serviceCharge2.setText("RS 100");
            estimatedCost = "100";
        }
...
*/
    ...
    private void GetDriverInfo()
    {
      ...
      */
        DatabaseReference CustomerDatabaseRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Mechanic").child(mechanicID);
        CustomerDatabaseRef.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0) {
...
*/
    ...
    {
        DriverLocationRef = FirebaseDatabase.getInstance().getReference().child("Mechanic Working").child(mechanicID).child("l");
                   ...
                   // CallCabCarButton.setText("Driver Found" + String.valueOf(Distance));
                    ...
                    messageButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            intent.putExtra("customerOrMechanic" ,"User");
 ...
 */
    ...
    private void getDriversAround(){
        ...
        DatabaseReference driverLocation = FirebaseDatabase.getInstance().getReference().child("Mechanic Available");
