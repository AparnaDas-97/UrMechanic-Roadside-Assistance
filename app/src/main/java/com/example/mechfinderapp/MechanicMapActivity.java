...

{
    ...
    private Button SettingsDriverButton,mRideStatus,mHistoryButton,availableServiceButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DriverworkingSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    connectDriver();
                    availableServiceButton.setVisibility(View.VISIBLE);
                    availableServiceButton.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent intent = new Intent(MechanicMapActivity.this,TestActivity.class);
        ...
        SettingsDriverButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MechanicMapActivity.this, MechanicSettingActivity.class);
                startActivity(intent);
                return;
            }
        });
        mHistoryButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intenthistory = new Intent(MechanicMapActivity.this, HistoryActivity.class);
