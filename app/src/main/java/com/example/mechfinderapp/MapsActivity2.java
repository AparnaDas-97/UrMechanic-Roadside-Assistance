        ...
        com.google.android.gms.location.LocationListener
{
    ...
    private String driverID,customerID="",userID,service,serviceDescr,id;
...
*/
        ...
        SettingsDriverButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MapsActivity2.this, MechanicSettingActivity.class);
        ...
        mHistoryButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intenthistory = new Intent(MapsActivity2.this, HistoryActivity.class);
    ...
    private void GetAssignedCustomerRequest()
    {
        AssignedCustomerRef = FirebaseDatabase.getInstance().getReference().child("Users")
                .child("Drivers").child(driverID).child("Customers Requests").child("CustomerReqID");
...
*/
    ...
    {
        Intent welcomeIntent = new Intent(MapsActivity2.this,WelcomeActivity.class);
