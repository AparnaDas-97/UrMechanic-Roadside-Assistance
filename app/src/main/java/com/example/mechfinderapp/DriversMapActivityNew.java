...
public class DriversMapActivityNew extends FragmentActivity implements OnMapReadyCallback,
...

{
    ...
    private Button LogoutDriverButton,AvailableServiceButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drivers_map_new);
        ...
        AvailableServiceButton = (Button)findViewById(R.id.available_service);
        ...
        AvailableServiceButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DriversMapActivityNew.this, TestActivity.class);
        ...
        SettingsDriverButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DriversMapActivityNew.this, MechanicSettingActivity.class);
                startActivity(intent);
                return;
            }
        });
...
*/
    ...
    {
        Intent welcomeIntent = new Intent(DriversMapActivityNew.this,WelcomeActivity.class);
