...
public class CustomersMapActivityBackup extends FragmentActivity implements OnMapReadyCallback,
...

{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
        ...
        CallCabCarButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(requestBol)
                {
                    ...
                    {
                        DriversRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Mechanic").child(driverFoundID).child("Customers Requests");
        ...
        CustomerSettingButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CustomersMapActivityBackup.this,CustomerSettingActivity.class);
    ...
    {
        DriverAvailableRef = FirebaseDatabase.getInstance().getReference().child("Mechanic Available");
       ...
       geoQuery = geoFire.queryAtLocation(new GeoLocation(CustomerPickUpLocation.latitude,CustomerPickUpLocation.longitude),radius);
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                ...
                {
                    DatabaseReference CustomerDatabase = FirebaseDatabase.getInstance().getReference().child("Users").child("Mechanic").child(key);
    ...
    private void GetDriverInfo()
    {
        ...
        DatabaseReference CustomerDatabaseRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Mechanic").child(driverFoundID);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0)
                {
                    ...
                    if(map.get("business") !=null)
                    {
                        ...
                        DriverCar.setText(map.get("business").toString());
                    }
    ...
    {
        DriverLocationRef = FirebaseDatabase.getInstance().getReference().child("Mechanic Working").child(driverFoundID).child("l");
        DriverLocationRefListener = DriverLocationRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists() && requestBol)
                        {
                            ...
                            if (Distance<100){
                                CallCabCarButton.setText("mechanic is Here");
                            }else{
                                CallCabCarButton.setText("Mechanic: " + String.valueOf(Distance));
                            }
    ...
    {
        Intent welcomeIntent = new Intent(CustomersMapActivityBackup.this,WelcomeActivity.class);
