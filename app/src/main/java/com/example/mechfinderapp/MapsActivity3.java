...
public class MapsActivity3 extends FragmentActivity  implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(id!=null)
        {
            ...
            Intent intent = new Intent(MapsActivity3.this, MechanicMapActivity.class);
            startActivity(intent);
        }
                       ...
                       // GetRecordServiceWorking();
                        ...
                        messageButton.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                intent.putExtra("customerOrMechanic" ,"Mechanic");
...
*/
    ...
    private void showDialog() {
        ...
        {
            serviceCharge2.setText("RM 150");
            serviceAmount = 50;
        }
        if(service.equals("Tyre"))
        {
            serviceCharge2.setText("RM 120");
            serviceAmount = 20;
        }
        if(service.equals("Others"))
        {
            serviceCharge2.setText("RM 100");
            serviceAmount = 10;
        }
    ...
    private void GetDriverInfo() {
        DatabaseReference DriverDatabaseRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Mechanic").child(driverID);
