...
public class MechanicSettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  DriverRadioGroup = (RadioGroup) findViewById(R.id.radioGroup);
        ...
        DriverDatabaseRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Mechanic").child(userID);
        ...
        DriverDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0)
                {
                    ...
                    {
                        DriverCar = map.get("business").toString();
...
*/
  //      DriverService = radioButton.getText().toString();
        ...
        userInfo.put("business",DriverCar);
